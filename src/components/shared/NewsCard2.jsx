...
const NewsCard2 = ({ news, index }) => {
  ...
  return (
    ...
    >
      <Link href={`/news/${slug}`} className="grid grid-cols-4 ">
        {/* Image */}
        <div className="relative h-full w-full aspect-[3/3] overflow-hidden">
          <Image
        ...
        <div className="px-3 py-2 col-span-3">
          ...
          {/* Read More */}
          <p className="text-primary text-xs md:text-sm font-semibold mt-2.5 inline-block hover:underline">
            Read More →
          </p>
        </div>
      </Link>
