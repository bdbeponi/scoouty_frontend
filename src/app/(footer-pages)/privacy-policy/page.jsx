      ...
      <section className="max-w-[1200px] mx-auto px-4 py-14 space-y-10">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-3">
            We may collect personal information such as your name or email
            address only when you voluntarily provide it, for example when you
            contact us through email.
          </p>
          <p className="text-gray-700 leading-relaxed">
            We also collect non-personal information such as browser type,
            device information, pages visited, and time spent on the website.
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-1 mb-3">
            <li>Respond to your queries and emails</li>
