...
export default function TermsAndConditionsPage() {
  return (
    <main className="bg-gray-50">
      ...
      {/* CONTENT */}
      <section className="max-w-[900px] mx-auto px-4 py-14 space-y-8">
        {/* Use of Website */}
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Vehicle specifications, prices, features, and launch details may
            change without notice. Users are advised to verify information with
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1">
            ...
            <li>Post or transmit harmful, misleading, or offensive material</li>
          </ul>
          <p className="text-gray-700 leading-relaxed mt-2">
            Violation of these terms may result in restricted access or legal
            action.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            website shall be subject to the jurisdiction of Indian courts.
          </p>
        </div>
