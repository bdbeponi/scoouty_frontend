...
const ScootersFilterComponents = () => {
  ...
  const category = searchParams.get("category") || "scooters";
  ...
  const apiParams = useMemo(() => {
    ...
    return params;
  }, [page, search, category, filterParams]);
...
export default ScootersFilterComponents;
